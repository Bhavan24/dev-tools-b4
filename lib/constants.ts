...
export const TOOLS = [
  ...
  },
  {
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Paste a git diff or list of changed files and get a Conventional Commits-formatted commit message generated by AI.',
    shortDescription: 'Generate commit messages with AI',
  },
  {
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Describe what you want to match in plain English and get a regex with explanation and examples. Pairs with the existing Regex Parser.',
  ...
  },
  {
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Paste a stack trace or error message and get a plain-language explanation with root cause analysis and step-by-step fix suggestions.',
    shortDescription: 'Explain errors with AI',
  },
  {
    id: 'ai-log-analyzer',
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Paste server or application logs and get a structured summary of errors, anomalies, patterns, and recommended next steps.',
    shortDescription: 'Analyze logs with AI',
  },
  {
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Describe your application stack and get a production-ready Dockerfile with multi-stage builds, non-root user, and optimized layer caching.',
    shortDescription: 'Generate Dockerfiles with AI',
  },
  {
    id: 'ai-architecture-diagram',
    name: 'AI Architecture Diagram Generator',
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Describe your system and get Mermaid diagram source code. Pairs with the Mermaid Preview tool for instant visualization.',
    shortDescription: 'Generate architecture diagrams with AI',
  },
  {
    ...
    category: TOOLS_CATEGORIES.AI_TOOLS,
    description:
      'Paste a prompt and get an analysis of issues plus an optimized version with clearer instructions, better context, and more effective framing.',
    shortDescription: 'Optimize prompts with AI',
  },
  {
    id: 'ai-release-notes',
